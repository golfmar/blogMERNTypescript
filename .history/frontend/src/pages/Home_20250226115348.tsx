    ...
    <>
      <section>
        ...
        <p>
          ...
          Benutzer in der Datenbank und überträgt ihn an den Client. Dieser Link
          wird dann zusammen mit den anderen Postdaten gesendet und im Browser
          auf der Postkomponente geöffnet. Die Postseitenfilterung und
